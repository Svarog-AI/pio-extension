...
**Scan all \`### Step N:\` headings** and check that none have titles whose primary purpose is verification. The following patterns are forbidden as step titles:
...
**If all headings are clean:** Proceed to \`signal-completion\` without further iteration.`,
  },
  {
