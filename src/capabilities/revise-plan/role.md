...
Your first user message will tell you the goal workspace directory path. **Remember this path** — this is where the input requirements file, your output `PLAN.md`, `PLAN_ARCHIVE/`, and completed work folders live.
