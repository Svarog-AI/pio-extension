...
Before writing GOAL.md, verify the following four dimensions. Follow the `grill-me` skill for probing technique.
...
### Step 5: Checkout a dedicated branch
...
### Step 6: Write GOAL.md

When you have enough information, write `GOAL.md` into the goal workspace directory. The file must have the following sections, in this order (the fourth section is optional):
