...
Before writing or running tests, check for project-specific guidance:
- **`.pio/PROJECT/DEVELOPMENT.md`** — Test directory conventions, test runner configuration, and development workflow.
- **`.pio/PROJECT/CONVENTIONS.md`** — Coding standards, linting rules, and project-specific agent instructions.

These files are auto-generated by `/pio-project-context` and may not exist in all projects.
